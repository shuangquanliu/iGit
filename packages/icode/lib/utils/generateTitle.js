...
exports.generateTitle = async function () {
   ...
   / // /   / / / / / / / _/     / /    / /    / /     ${colors.white(`welcome ${colors.red('❤️')} iGit cli`)}
...
${newPackageVersion ? (('\n' + 'Latest Version: ' + colors.bold.red(newPackageVersion)) + ' 更新请输入: ' + colors.bold.yellow('npm install @igit-js/igit -g')) : ''}
      `
    clearConsole(title)
}
...
async function postAction() {
    ...
    const currentPkgName = '@igit-js/igit'
